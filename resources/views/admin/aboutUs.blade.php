...
<div id="wrapper">
    ...
    <header id="header">
        <div class="inner">
            ...
            <a href="index" class="logo">
                <span class="fa fa-home"></span> <span class="title">Lakeshore Homelookers</span></a>
    ...
    <div id="main">
        <H3>1. COMPANY PROFILE</H3>
            <p> Founded on August 28, 2001, Lakeshore Homelookers operates in the field of real estate business,
               building villas for rent. With the slogan "Breaking time, through space" with a sustainable development strategy,
                taking Real Estate as a focus area, Lakeshore Homelookers is constantly connecting between buyers and sellers in the filed.
             Real Estate, bringing people closer together, over the distance of time and space, is a reliable place for real estate investment - an area that is constantly evolving over time.
            </p>

        <h2 style="align-text: center", color="red">"Breaking Time, through space"</h2>

        <div class="card">
            <img src="{{ url('/images/img_3.png') }}" alt="image" >
{{--            <div class="container">--}}
{{--                <h4><b>John Doe</b></h4>--}}
...
{{--            </div>--}}
        ...
        <h3>2. VISION</h3>
        <ul>
            <li>Acquiring domestic area</li>
            <li>Reaching far across continents</li>
        </ul>

        <h3>3.MISSION</h3>
        <ul>
            <li>Creating the community</li>
            <li>Building Destinations</li>
            <li>Nurture Happiness</li>
        </ul>
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="{{ url('/images/slider-image-4-1024x614.jpg') }}" alt="Fourth slide">
            </div>
